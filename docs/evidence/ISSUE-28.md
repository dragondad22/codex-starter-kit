...
#30 publishes exact runner evidence, bounded filesystem assumptions, native capability
states, and explicit unsupported claims in the Phase 1 support matrix.
