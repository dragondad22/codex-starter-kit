...
func TestRunEmitsDeterministicCredentialFreeBoundArtifacts(t *testing.T) {
	...
	if request.Repository != "." || request.Intent.ManagedID != "issue:102" || request.Intent.HeadBranch != deliveryBranch || deliveryBranch != "contract/issue-75-20260721-05" || request.Intent.MergeMethod != "squash" {
